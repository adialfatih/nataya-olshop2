...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?=base_url('assets2/');?>css/autoComplete.02.css">
		<?php } ?>
		...
		<style>
			...
			label.pilihanin:hover, .pilihanin.active {
				background-color: #1e8704;
				color: #fff;
			}
			label.pilihanout:hover, .pilihanout.active {
				background-color: #b0041d;
				color: #fff;
			}
			.sow {width:100%;display:flex;align-items:center;gap:5px;}
			.sowimage, .sowimage img {
				width: 100%;
				position: relative;
			}
			.sowimage span {
