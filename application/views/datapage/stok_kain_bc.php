										...
										<div class="modal-content">
											...
											<div class="modal-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12 col-md-10" style="display:flex;align-items:center;gap:15px;">
                                                        <input class="form-control" name="dari" id="dari" type="text" placeholder="Masukan Asal Barang / Pengirim / Supplier" disabled required />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                ...
                                <div class="modal fade bs-example-modal-lg" id="modalKirim" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
									<div class="modal-dialog modal-lg modal-dialog-centered">
										<div class="modal-content">
											<div class="modal-header">
												<h4 class="modal-title" id="myLargeModalLabel">
                                                <i class="icon-copy bi bi-box-arrow-up-right" style="color:red;"></i>&nbsp;&nbsp; KIRIM KAIN
												</h4>
											...
											<div class="modal-body" id="bodyModalKain23">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12 col-md-10">
                                                        <select name="namakain" id="namakain" style="width: 100%; max-width: 350px;" class="form-control" onchange="ambiljeniskain(this.value)" required>
                                                            <option value="">--Pilih Kain--</option>
                                                ...
                                                <input type="hidden" id="stokPanjang" value="0" name="stokpanjang">
                                                <input type="hidden" id="stokRoll" value="0" name="stokroll">
                                                <input type="hidden" id="stokNilai" value="0" name="stoknilai">
                                                <div class="form-group row">
                                                    <label class="col-sm-12 col-md-2 col-form-label" for="jumlah2" id="idjumlahText">Jumlah Kirim</label>
                                                    <div class="col-sm-12 col-md-10">
                                                        <input class="form-control" style="width: 100%; max-width: 350px;" name="jumlah" id="jumlah2" type="text" placeholder="Masukan Panjang Kain Yang Dikirim" oninput="formatAngka(this)" onchange="cekdata()" required />
                                                        <small style="color:red;" id="notice1"></small>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-12 col-md-2 col-form-label" for="roll2">Jumlah Roll</label>
                                                    <div class="col-sm-12 col-md-10">
                                                        <input class="form-control" style="width:250px;" name="roll" oninput="formatAngka(this)" id="roll2" onchange="cekdata()" type="text" placeholder="Masukan Jumlah Roll" required />
                                                        <small style="color:red;" id="notice2"></small>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-12 col-md-2 col-form-label" for="nilai2">Harga</label>
                                                    <div class="col-sm-12 col-md-10">
                                                        ...
                                                        <div style="width:100%;background-color:#f8f9fa;padding:10px;font-size:12px;">
                                                            Total harga ini adalah harga kain persatuan di kali jumlah kain yang di kirim dan harus di bayarkan oleh produsen kepada anda sebagai pembayaran kain. Anda dapat mengubahnya sesuai kebutuhan.
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr>
                                                <strong>Rencana / Estimasi Produk : </strong>
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" id="productTable">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <select name="produks[]" id="produk25" style="min-width: 150px;" class="form-control" required>
                                                            ...
                                                            <td>
                                                                <select name="size[]" id="ukuran25" class="form-control" style="min-width: 150px;" required>
                                                            ...
                                                            <td>
                                                                <input type="text" name="warna[]" style="min-width: 150px;" id="warna25" class="form-control" required>
                                                            </td>
                                                            <td>
                                                                <input type="text" name="jml[]" style="min-width: 150px;" id="jml25" class="form-control" required>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="4">
                                            ...
                                            <div class="modal-footer">
                                                <a href="<?=base_url('data-kain/pengiriman');?>">
												<button type="button" class="btn btn-secondary">
													Riwayat Pengiriman
												</button></a>
