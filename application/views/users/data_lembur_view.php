					...
					<div class="card-box mb-30">
						...
						<div class="pb-20 table-responsive">
							<table class="data-table table stripe hover nowrap">
								...
								<tbody>
									<?php
										$_qr = $this->db->query("SELECT * FROM data_lembur ORDER BY tgl_lembur DESC");
										if($_qr->num_rows() > 0){
											$no=1;
												...
												<td>
													<div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
															...
															<?php if(strtolower($nama_login) == strtolower($yg_input) OR $nama_login=="Users"){ ?>
                                                            <a class="dropdown-item" href="javascript:void(0);" onclick="lbrs('<?=$_id;?>','<?=ucfirst($_dep);?>','<?=$_lbr;?>')" data-toggle="modal" data-target="#Medium-modal">
